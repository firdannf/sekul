...
@section('konten')
    ...
    <body>
        <h2 style="color: rgb(10,0,36)">Data Tugas</h2>
        <br />
        @if (Auth::user()->role == 'admin')
            <div class="demo">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-3">
                            <button class="btn btn-lg" data-toggle="modal" data-target="#TambahSoal">Tambah Tugas</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <table class="table table-striped table-hover" style="background-color: white">
            ...
            @foreach ($soal as $s)
                ...
                <div class="modal fade" id="DelSoal{{ $s->idsoal }}" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
