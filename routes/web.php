...
use App\Http\Controllers\RegisiterCon;
...
Route::get('register', [RegisiterCon::class, 'register'])->name('register');
Route::post('register/action', [RegisiterCon::class, 'actionregister'])->name('actionregister');

Route::get('user', [UserCon::class, 'user'])->name('user')->middleware('auth');
